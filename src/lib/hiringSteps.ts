...
export const HIRING_STEPS: HiringStepConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reportDOJ', label: 'Report D O J', type: 'date' },
  ...
  },
  {
    ...
    listColumns: [
      ...
      { key: 'positionDetails.department', label: 'Department' },
      { key: 'positionDetails.joiningDate', label: 'Date of Joining' },
      { key: 'declaration.hrVerifiedBy', label: 'Verification' },
      { key: 'status', label: 'Status' },
      { key: 'updatedAt', label: 'Last Update' }
    ],
    fields: [
  ...
  },
  {
    ...
    listColumns: [
      ...
      { key: 'nominee1FullName', label: 'Nominee1' },
      { key: 'nominee2FullName', label: 'Nominee2' },
      { key: 'verifiedBy', label: 'Verification' },
      { key: 'status', label: 'Status' },
      { key: 'updatedAt', label: 'Last Update' },
  ...
  },
  {
    ...
    listColumns: [
      ...
      { key: 'hrVerifiedBy', label: 'Verification' },
      { key: 'status', label: 'Status' },
      { key: 'updatedAt', label: 'Last Update' },
    ],
    fields: [
  ...
  },
  {
    ...
    listColumns: [
      { key: 'employeeName', label: 'Employee Name' },
      { key: 'designation', label: 'Position' },
      { key: 'primaryName', label: 'Emergency Contact' },
      { key: 'primaryMobile', label: 'Contact No' },
      { key: 'empCode', label: 'EMP Code' },
  ...
  },
  {
    ...
    listColumns: [
      ...
      { key: 'officialMobileNo', label: 'Official Mobile Number' },
    ...
    fields: [
      ...
      { name: 'hrName', label: 'Hr Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hrVerificationDate', label: 'Hr Verification Date', type: 'date' },
  ...
  },
  {
    ...
    postCreateActions: [{ label: 'Verify', method: 'PUT', pathSuffix: '/verify' }],
    fields: [
      { name: 'candidateName', label: 'Candidate Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'position', label: 'Position', type: 'text', placeholder: 'e.g., Value' },
      { name: 'department', label: 'Department', type: 'text', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reportingManagerDate', label: 'Reporting Manager Date', type: 'date' },
      { name: 'reviewPeriodStart', label: 'Review Period Start', type: 'date' },
      { name: 'reviewPeriodEnd', label: 'Review Period End', type: 'date' },
      { name: 'decision', label: 'Decision', type: 'select', options: ['Pending', 'Confirmed', 'Extended', 'Terminated'] },
      { name: 'extensionMonths', label: 'Extension (Months)', type: 'number', placeholder: 'e.g., 3' },
      { name: 'comments', label: 'Comments', type: 'textarea', placeholder: 'Any additional remarks...' }
    ],
    arrayFields: [
      {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reportingManager', label: 'Reporting Manager', type: 'text', placeholder: 'e.g., Value' },
      { name: 'dateOfEvaluation', label: 'Date Of Evaluation', type: 'date' },
