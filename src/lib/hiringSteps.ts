export type FieldType = 'text' | 'number' | 'date' | 'select' | 'textarea' | 'checkbox' | 'department';
...
export const HIRING_STEPS: HiringStepConfig[] = [
  {
    ...
    fields: [
      ...
      { name: 'department', label: 'Department', type: 'department', placeholder: 'e.g., Value' },
      ...
      { name: 'interviewDate', label: 'Interview Date', type: 'date', placeholder: 'e.g., Value' },
      ...
      { name: 'hrStatus', label: 'HR Review Status', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hrName', label: 'HR Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hrRemarks', label: 'HR Remarks', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hodDecision', label: 'HOD Final Status', type: 'text', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'dateOfInterview', label: 'Date Of Interview', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    listColumns: [
      ...
      { key: 'netTakeHome', label: 'Net Take Home' },
      { key: 'status', label: 'Status' },
      { key: 'updatedAt', label: 'Last Update' }
    ],
    fields: [
      ...
      { name: 'workLocation', label: 'Work Location', type: 'text', placeholder: 'e.g., Value' },
      { name: 'reportingTo', label: 'Reporting To', type: 'text', placeholder: 'e.g., Value' },
      { name: 'effectiveDate', label: 'Effective Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'department', label: 'Department', type: 'department', placeholder: 'e.g., Value' },
      { name: 'joiningDate', label: 'Joining Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'reportingTo', label: 'Reporting To', type: 'text', placeholder: 'e.g., Value' },
      { name: 'failureToReportDate', label: 'Failure To Report Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'designation', label: 'Designation', type: 'text', placeholder: 'e.g., Value' },
      { name: 'department', label: 'Department', type: 'department', placeholder: 'e.g., Value' },
      { name: 'dateOfJoining', label: 'Date Of Joining', type: 'date', placeholder: 'e.g., Value' },
      { name: 'workLocation', label: 'Work Location', type: 'text', placeholder: 'e.g., Value' },
      { name: 'employeeCode', label: 'Employee Code', type: 'text', placeholder: 'e.g., Value' },
      { name: 'employeeSignatureDate', label: 'Employee Signature Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'hrName', label: 'Hr Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hrSignatureDate', label: 'Hr Signature Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'hrRemarks', label: 'Hr Remarks', type: 'text', placeholder: 'e.g., Value' },],
    arrayFields: [{
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'requestDate', label: 'Request Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'dob', label: 'Dob', type: 'date', placeholder: 'e.g., Value' },
      ...
      { name: 'hrDate', label: 'Hr Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'hrRemarks', label: 'Hr Remarks', type: 'text', placeholder: 'e.g., Value' },
      // Personal Details
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'verifiedBy', label: 'Verified By', type: 'text', placeholder: 'e.g., Value' },
      { name: 'verificationDate', label: 'Verification Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'hrRemarks', label: 'Hr Remarks', type: 'text', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      { name: 'candidateName', label: 'Candidate Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'department', label: 'Department', type: 'department', placeholder: 'e.g., Value' },
      { name: 'date', label: 'Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'witness1Date', label: 'Witness1 Date', type: 'date', placeholder: 'e.g., Value' },
      ...
      { name: 'witness2Date', label: 'Witness2 Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'department', label: 'Department', type: 'department', placeholder: 'e.g., Value' },
      { name: 'position', label: 'Position', type: 'text', placeholder: 'e.g., Value' },
      { name: 'commencementDate', label: 'Commencement Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'reportingTime', label: 'Reporting Time', type: 'text', placeholder: 'e.g., Value' },
      { name: 'reportingLocation', label: 'Reporting Location', type: 'text', placeholder: 'e.g., Value' },
      { name: 'monthlyCTC', label: 'Monthly C T C', type: 'text', placeholder: 'e.g., Value' },
      { name: 'annualCTC', label: 'Annual C T C', type: 'text', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reportingTo', label: 'Reporting To', type: 'text', placeholder: 'e.g., Value' },
      { name: 'signatureDate', label: 'Signature Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'hrName', label: 'Hr Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'hrVerificationDate', label: 'Hr Verification Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'designation', label: 'Designation', type: 'text', placeholder: 'e.g., Value' },
      { name: 'joiningDate', label: 'Joining Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'reviewDate', label: 'Review Date', type: 'date', placeholder: 'e.g., Value' },
      { name: 'reportingManager', label: 'Reporting Manager', type: 'text', placeholder: 'e.g., Value' },
      { name: 'reportingManagerSignatureName', label: 'Reporting Manager Signature Name', type: 'text', placeholder: 'e.g., Value' },
      { name: 'reportingManagerDate', label: 'Reporting Manager Date', type: 'date', placeholder: 'e.g., Value' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reportingManager', label: 'Reporting Manager', type: 'text', placeholder: 'e.g., Value' },
      { name: 'dateOfEvaluation', label: 'Date Of Evaluation', type: 'date', placeholder: 'e.g., Value' },
