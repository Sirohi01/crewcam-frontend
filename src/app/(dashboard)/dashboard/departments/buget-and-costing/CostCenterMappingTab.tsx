...
import {
  Search, Filter, Users, Building, LayoutDashboard, Layers,
  Plus, Wallet, FileText, LineChart, ChevronRight, ChevronLeft,
  MoreVertical, Info
} from 'lucide-react';
...
export default function CostCenterMappingTab() {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-2 items-start">
      ...
      {/* RIGHT SIDEBAR */}
      <div className="xl:col-span-3 min-w-0 flex flex-col gap-2 h-full overflow-y-auto custom-scrollbar pr-1 pb-1">

        {/* About Cost Hierarchy Card */}
        <div className="rounded-xl border border-zinc-200 bg-white shadow-sm p-4 shrink-0">
          <div className="flex items-center gap-1.5 mb-2 text-[13.5px] font-bold text-zinc-900">
          ...
          <div className="flex flex-col relative before:absolute before:left-[7px] before:top-2 before:bottom-6 before:w-px before:bg-slate-200">
            ...
            <div className="flex items-start gap-2 mb-2 relative z-10 pl-4 before:absolute before:left-[-9px] before:top-2.5 before:w-3 before:h-px before:bg-slate-200">
            ...
            <div className="flex items-start gap-2 mb-2 relative z-10 pl-8 before:absolute before:left-[-5px] before:top-2.5 before:w-3 before:h-px before:bg-slate-200">
        ...
        {/* Quick Actions Card */}
        <div className="rounded-xl border border-zinc-200 bg-white shadow-sm p-4 shrink-0">
          <h3 className="text-[13.5px] font-bold text-zinc-900 mb-2">Quick Actions</h3>
        ...
        <div className="rounded-xl border border-zinc-200 bg-white shadow-sm p-4 shrink-0">
          <h3 className="text-[13.5px] font-bold text-zinc-900 mb-2">Related Reports</h3>
