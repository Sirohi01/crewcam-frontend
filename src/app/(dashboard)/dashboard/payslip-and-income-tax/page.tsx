            ...
            <thead>
              <tr className="border-y border-zinc-100 bg-white">
                {['Month', 'Pay Date', 'Take Home Salary', 'Gross Salary', 'Deductions', 'Status', 'Action'].map((h) => (
                  <th key={h} className="whitespace-nowrap px-3 py-1.5 text-left text-[11px] font-semibold text-zinc-800">
                    {h}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              {payslips.map((p) => (
                <tr key={p.month} className="border-b border-zinc-100 last:border-0 hover:bg-zinc-50/40">
                  ...
                  <td className="whitespace-nowrap px-3 py-1.5 text-[11px] font-semibold text-emerald-600">₹{p.takeHome}</td>
                  <td className="whitespace-nowrap px-3 py-1.5 text-[11px] font-medium text-zinc-800">₹{p.gross}</td>
                  <td className="whitespace-nowrap px-3 py-1.5 text-[11px] text-zinc-500">₹{p.deductions}</td>
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="flex min-w-0 items-center justify-between gap-2 border-t border-zinc-100 pt-2">
            ...
            <span className="min-w-0 truncate text-right text-[11px] font-semibold text-zinc-800">₹78,450 (78.45%)</span>
          </div>
        </div>
      </div>
    </Card>
