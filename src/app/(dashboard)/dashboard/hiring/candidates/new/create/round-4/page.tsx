...
export default function InterviewUI() {
  return (
    <div className="w-full max-w-[1600px] px-2 py-1 mx-auto space-y-2 font-sans text-zinc-900 min-h-screen">`n    <div className="w-full max-w-[1600px] mx-auto p-2 font-sans text-zinc-900 bg-white min-h-[calc(100vh-48px)]">
