              ...
              return (
                <div key={meeting._id} className="flex items-center gap-4 px-4 py-3.5 hover:bg-zinc-50/60 dark:hover:bg-zinc-800/40 transition-colors">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <Link href={`/dashboard/meetings/${meeting._id}`} className="text-xs font-medium border border-zinc-200 text-zinc-600 px-3 py-1.5 rounded-md hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 transition-colors">
                      View Details
                    </Link>
                    <Link href={`/dashboard/meetings/${meeting._id}/mom`} className="text-xs font-medium border border-zinc-200 text-zinc-600 px-3 py-1.5 rounded-md hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 transition-colors">
                      View MoM
                    </Link>
