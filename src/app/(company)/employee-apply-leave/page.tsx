    ...
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#F7F8FA]">
      <div className="mx-auto w-full max-w-[1300px] space-y-1 p-2">
        ...
        <div className="flex items-center gap-1.5 text-[13px] text-zinc-400">
          ...
          <Link href="/company/leaves" className="hover:text-zinc-600">Leave</Link>
          <ChevronRight size={13} />
        ...
        <div className="grid w-full grid-cols-1 gap-1.5 xl:grid-cols-[1fr_340px]">
          ...
          <div className="min-w-0 space-y-1.5">
            ...
            <Card className="p-2">
              ...
              <Link href="/company/leaves" className="mt-1.5 inline-flex items-center gap-1 text-[12.5px] font-semibold text-blue-600 hover:text-blue-700">
            ...
            <Card className="p-2">
              ...
              <Link href="/company/leaves/policy" className="mt-1.5 inline-flex items-center gap-1 text-[12.5px] font-semibold text-blue-600 hover:text-blue-700">
