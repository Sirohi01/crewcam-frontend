...
export default function PublicProfile() {
  ...
  const handleEditProfile = () => router.push('/company/employees/my-profile');
  ...
  return (
    <div className="flex h-[calc(100vh-48px)] min-h-[650px] flex-col gap-2 overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="no-print flex items-center text-[11px] font-medium shrink-0">
        <button onClick={() => router.push('/company')} className="hover:text-indigo-600 transition-colors">Dashboard</button>
        <ChevronRight size={12} className="mx-1" />
        <button onClick={() => router.push('/company/employees/my-profile')} className="hover:text-indigo-600 transition-colors">My Profile</button>
        <ChevronRight size={12} className="mx-1" />
