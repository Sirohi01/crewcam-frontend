...
const tabs = [
  { name: 'Personal Info', icon: User, active: false, href: '/company/employee/personal' },
  { name: 'Family Details', icon: Users, active: false, href: '/company/employees/family' },
  { name: 'Bank Details', icon: Landmark, active: true, href: '/company/employees/bank-details' },
  { name: 'Education', icon: GraduationCap, active: false, href: '/company/employee/education' },
  { name: 'Experience', icon: Briefcase, active: false, href: '/company/employee/experience' },
  { name: 'Documents', icon: FileText, active: false, href: '/company/employee/documents' },
  { name: 'Skills', icon: Activity, active: false, href: '/company/employee/skills' },
  { name: 'Assets', icon: Box, active: false, href: '/company/employees/assets' },
  { name: 'Emergency', icon: ShieldAlert, active: false, href: '/company/employee/emergency' },
  { name: 'More Info', icon: PlusCircle, active: false, href: '/company/employee/more' },
];
