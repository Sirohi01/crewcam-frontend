      ...
      <section className="relative overflow-hidden rounded-[26px] bg-[#17142c] px-6 py-8 text-white shadow-[0_18px_45px_-22px_rgba(76,29,149,0.8)] md:px-8 md:py-10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Link href="/company/communications/quotes" className="text-xs font-medium bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-4 py-2.5 rounded-xl inline-flex items-center gap-2 transition-all shadow-sm hover:shadow-indigo-500/20 hover:-translate-y-0.5">
              <Megaphone size={16} className="text-indigo-300" /> Daily Quotes
            </Link>
            <Link href="/company/communications/queries" className="text-xs font-medium bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-4 py-2.5 rounded-xl inline-flex items-center gap-2 transition-all shadow-sm hover:shadow-indigo-500/20 hover:-translate-y-0.5">
