      ...
      <section className="relative overflow-hidden rounded-[26px] bg-[#111827] px-6 py-8 text-white shadow-[0_18px_45px_-22px_rgba(16,185,129,0.5)] md:px-8 md:py-10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Link href="/company/communications/notifications" className="text-xs font-medium bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-4 py-2.5 rounded-xl inline-flex items-center gap-2 transition-all shadow-sm hover:shadow-emerald-500/20 hover:-translate-y-0.5">
              <BellRing size={16} className="text-emerald-300" /> HR Notifications
            </Link>
            <Link href="/company/communications/quotes" className="text-xs font-medium bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-4 py-2.5 rounded-xl inline-flex items-center gap-2 transition-all shadow-sm hover:shadow-emerald-500/20 hover:-translate-y-0.5">
