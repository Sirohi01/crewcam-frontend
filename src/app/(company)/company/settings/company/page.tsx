          ...
          <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm h-[380px] flex flex-col">
            <CardContent className="p-0 flex-1 flex flex-col">
              <div className="flex items-center justify-between p-4 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <Link href="/company/branches" className="text-xs font-md text-indigo-600 hover:text-indigo-700 flex items-center gap-1">View All Branches &gt;</Link>
              </div>
          ...
          <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm h-[184px] flex flex-col">
            <CardContent className="p-0 flex flex-col flex-1 overflow-hidden">
              <div className="flex items-center justify-between p-4 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <Link href="/company/departments" className="text-xs font-md text-indigo-600 hover:text-indigo-700">View All</Link>
              </div>
              ...
              {counts.departments > departments.length && (
                <div className="p-3 text-center border-t border-zinc-100 dark:border-zinc-800">
                  <Link href="/company/departments" className="text-xs font-md text-indigo-600">+{counts.departments - departments.length} more departments</Link>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm h-[184px] flex flex-col">
            <CardContent className="p-0 flex flex-col flex-1 overflow-hidden">
              <div className="flex items-center justify-between p-4 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <Link href="/company/designations" className="text-xs font-md text-indigo-600 hover:text-indigo-700">View All</Link>
              </div>
              <div className="p-2 space-y-1 overflow-y-auto flex-1">
                {designations.map(d => (
                  <div key={d._id} className="flex justify-between items-center px-3 py-2 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
              ...
              {counts.designations > designations.length && (
                <div className="p-3 text-center border-t border-zinc-100 dark:border-zinc-800">
                  <Link href="/company/designations" className="text-xs font-md text-indigo-600">+{counts.designations - designations.length} more designations</Link>
                </div>
              )}
            </CardContent>
          </Card>
