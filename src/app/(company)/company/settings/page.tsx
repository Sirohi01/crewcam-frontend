...
const highlightCards = [
  { title: 'My Account', desc: 'Profile & Personal Info', cta: 'Manage Profile', href: '/company/employees/my-profile', icon: User, bg: 'bg-blue-100', fg: 'text-blue-600' },
  { title: 'Security', desc: 'Password & 2FA', cta: 'Manage Security', href: '/company/settings/security', icon: ShieldCheck, bg: 'bg-emerald-100', fg: 'text-emerald-600' },
  { title: 'Notifications', desc: 'Alerts & Reminders', cta: 'Manage Alerts', href: '/company/notifications', icon: Bell, bg: 'bg-purple-100', fg: 'text-purple-600' },
  { title: 'Preferences', desc: 'Display & Language', cta: 'Manage Preferences', href: '/company/coming-soon', icon: SlidersHorizontal, bg: 'bg-orange-100', fg: 'text-orange-600' },
  { title: 'Data & Privacy', desc: 'Backup & Data Control', cta: 'Manage Data', href: '/company/coming-soon', icon: CloudCog, bg: 'bg-cyan-100', fg: 'text-cyan-600' },
];

const accountAccess = [
  { title: 'Personal Information', desc: 'Update your personal details', href: '/company/employees/my-profile', icon: UserCircle, bg: 'bg-blue-100', fg: 'text-blue-600' },
  { title: 'Change Password', desc: 'Update your login password', href: '/company/settings/security', icon: Lock, bg: 'bg-emerald-100', fg: 'text-emerald-600' },
  { title: 'Two-Factor Authentication', desc: 'Add extra layer of account security', href: '/company/settings/security', icon: ShieldCheck, bg: 'bg-purple-100', fg: 'text-purple-600' },
  { title: 'Login Sessions', desc: 'Manage active sessions', href: '/company/settings/sessions', icon: Laptop, bg: 'bg-orange-100', fg: 'text-orange-600' },
  { title: 'Device Management', desc: 'Manage trusted devices', href: '/company/coming-soon', icon: Smartphone, bg: 'bg-cyan-100', fg: 'text-cyan-600' },
  { title: 'API Access', desc: 'Manage API keys and integrations', href: '/company/coming-soon', icon: Code2, bg: 'bg-rose-100', fg: 'text-rose-600' },
];

const hrmsConfig = [
  { title: 'Leave Settings', desc: 'Configure leave types and policies', href: '/company/leaves', icon: CalendarDays, bg: 'bg-emerald-100', fg: 'text-emerald-600' },
  { title: 'Attendance Settings', desc: 'Work hours & attendance rules', href: '/company/attendance', icon: Clock, bg: 'bg-blue-100', fg: 'text-blue-600' },
  { title: 'Holiday Calendar', desc: 'Manage company holidays', href: '/company/coming-soon', icon: CalendarDays, bg: 'bg-orange-100', fg: 'text-orange-600' },
  { title: 'Payroll Settings', desc: 'Salary components & process', href: '/company/finance/payroll', icon: IndianRupee, bg: 'bg-purple-100', fg: 'text-purple-600' },
  { title: 'Reimbursement Settings', desc: 'Approval limits & categories', href: '/company/finance/expenses', icon: Wallet, bg: 'bg-cyan-100', fg: 'text-cyan-600' },
  { title: 'Tax & Compliance', desc: 'TDS, PF, ESI & other compliance', href: '/company/coming-soon', icon: FileText, bg: 'bg-blue-100', fg: 'text-blue-600' },
];

const systemPreferences = [
  { title: 'Language & Region', href: '/company/coming-soon', icon: Globe },
  { title: 'Date & Time Format', href: '/company/coming-soon', icon: Clock3 },
  { title: 'Theme & Display', href: '/company/coming-soon', icon: Palette },
  { title: 'Dashboard Customization', href: '/company/coming-soon', icon: LayoutDashboard },
  { title: 'Email Preferences', href: '/company/coming-soon', icon: Mail },
];

const supportOthers = [
  { title: 'Helpdesk Settings', desc: 'Manage ticket categories & SLAs', href: '/company/support/helpdesk', icon: LifeBuoy, bg: 'bg-rose-100', fg: 'text-rose-600', shape: 'circle' as const },
  { title: 'Notification Templates', desc: 'Customize email & SMS templates', href: '/company/coming-soon', icon: Bell, bg: 'bg-blue-100', fg: 'text-blue-600', shape: 'circle' as const },
  { title: 'Import / Export Data', desc: 'Import or export system data', href: '/company/coming-soon', icon: Download, bg: 'bg-emerald-100', fg: 'text-emerald-600', shape: 'circle' as const },
  { title: 'Audit Logs', desc: 'View system activity logs', href: '/company/coming-soon', icon: ScrollText, bg: 'bg-gray-100', fg: 'text-gray-600', shape: 'circle' as const },
];

const quickShortcuts = [
  { title: 'Company Profile', href: '/company/settings/company', icon: ClipboardList, bg: 'bg-blue-100', fg: 'text-blue-600' },
  { title: 'Organization Structure', href: '/company/branches', icon: Network, bg: 'bg-purple-100', fg: 'text-purple-600' },
  { title: 'Roles & Permissions', href: '/company/settings/roles', icon: UserCog, bg: 'bg-orange-100', fg: 'text-orange-600' },
  { title: 'Employee Onboarding', href: '/company/employees', icon: FileText, bg: 'bg-blue-100', fg: 'text-blue-600' },
  { title: 'Workflows & Approvals', href: '/company/coming-soon', icon: GitBranch, bg: 'bg-emerald-100', fg: 'text-emerald-600' },
];
