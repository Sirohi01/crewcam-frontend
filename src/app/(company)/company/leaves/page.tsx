    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-300 pb-8 max-w-[1400px] mx-auto">
      <div className="flex items-center justify-between pb-4 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-3">
          <Link href="/company/leave-statistics" className="text-sm font-medium bg-white border border-zinc-200 shadow-sm hover:bg-zinc-50 text-zinc-700 px-4 py-2.5 rounded-lg inline-flex items-center gap-2 dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-all">
            <TrendingUp size={16} className="text-indigo-600 dark:text-indigo-400" /> Leave Statistics
          </Link>
          <Link href="/company/leave-credit" className="text-sm font-medium bg-white border border-zinc-200 shadow-sm hover:bg-zinc-50 text-zinc-700 px-4 py-2.5 rounded-lg inline-flex items-center gap-2 dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-all">
