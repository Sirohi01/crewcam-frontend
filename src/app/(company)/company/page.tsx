...
import EmployeeDashboard from './employees/dashboard/page';
...
function MyPerformanceCard() {
  ...
  return (
    <ChartCard title="My Performance" action="View Details" href="/company/performance/me" className="xl:h-[270px]">
...
function WelcomeHeader({ category }: { category?: string }) {
  ...
  let dashboardOptions = [
    { label: 'Admin Dashboard', href: '/company/admin-dashboard' },
    { label: 'HR Dashboard', href: '/company/hr-dashboard' },
    { label: 'Employee Dashboard', href: '/company/employees/dashboard' },
  ];
  ...
  if (category === 'employee' || category === 'reporting_manager' || category === 'finance') {
    ...
    dashboardOptions = [
      { label: 'HOD Dashboard', href: '/company/hod-dashboard' },
      { label: 'Employee Dashboard', href: '/company/employees/dashboard' },
    ];
  }
...
function KpiCard({ widgetKey }: { widgetKey: string }) {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => (await api.get(`/company/widget-data/${widgetKey}`)).data,
  });
    ...
    <Card className="border-zinc-200/80 shadow-sm">
      <CardContent className="px-3 py-2">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link href="/company/alerts" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
...
function AttendanceOverview({ attendance }: { attendance: any }) {
  ...
  const rows = [
    { label: 'Present', count: present, pct: ((present / teamSize) * 100).toFixed(1), color: '#22c55e', href: '/company/attendance?status=present' },
    { label: 'Half Day', count: 60, pct: '5.2', color: '#f59e0b', href: '/company/attendance?status=half-day' },
    { label: 'Absent', count: 196, pct: '15.7', color: '#ef4444', href: '/company/attendance?status=absent' },
    { label: 'On Leave', count: 45, pct: '6.1', color: '#3b82f6', href: '/company/attendance?status=on-leave' },
    { label: 'WFH', count: 72, pct: '5.8', color: '#8b5cf6', href: '/company/attendance?status=wfh' },
  ];
      ...
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        ...
        <div className="rounded-lg border border-zinc-100 overflow-hidden">
          ...
          <div className="grid grid-cols-4 items-center px-3 py-1.5 border-t-2 border-zinc-200 bg-zinc-50/60">
            ...
            <div className="flex justify-center">
              <Link href="/company/attendance" className="inline-flex items-center rounded border border-blue-200 px-1.5 py-0.5 text-[9px] font-medium text-blue-600 hover:bg-blue-50 transition-colors">
                <Eye size={9} />
              </Link>
            </div>
          </div>
...
function LeaveOverview() {
  return (
    <ChartCard title="Leave Overview" action="View Report" href="/company/leaves" className="xl:h-[270px]">
...
function PerformanceOverview() {
  return (
    <ChartCard title="Performance Overview" action="View Dashboard" href="/company/performance" className="xl:h-[270px]">
      <div className="flex items-center gap-4 h-full">
        {/* Left: large donut */}
        <div className="relative shrink-0" style={{ width: 130, height: 130 }}>
          <ResponsiveContainer width="100%" height="100%">
...
function QuickActions() {
  ...
  const actions: ActionItem[] = [
    { href: '/company/leaves/approve', icon: <CalendarCheck size={16} />, label: 'Approve Leave', color: 'text-emerald-600 bg-emerald-50' },
    { href: '/company/attendance/approve', icon: <ScanFace size={16} />, label: 'Approve Attendance', color: 'text-blue-600 bg-blue-50' },
    { href: '/company/performance/appraisal/new', icon: <Star size={16} />, label: 'Start Appraisal', color: 'text-violet-600 bg-violet-50' },
    { href: '/company/appreciation/new', icon: <PartyPopper size={16} />, label: 'Give Appreciation', color: 'text-pink-600 bg-pink-50' },
    { href: '/company/discipline/warning/new', icon: <AlertTriangle size={16} />, label: 'Issue Warning', color: 'text-rose-600 bg-rose-50' },
    { href: '/company/hiring/manpower/new', icon: <Briefcase size={16} />, label: 'Create Requisition', color: 'text-cyan-600 bg-cyan-50' },
    { href: '/company/training/assign', icon: <GraduationCap size={16} />, label: 'Assign Training', color: 'text-amber-600 bg-amber-50' },
    { href: '/company/tasks/new', icon: <ListTodo size={16} />, label: 'New Task', color: 'text-indigo-600 bg-indigo-50' },
    { href: '/company/finance/imprest/new', icon: <Wallet2 size={16} />, label: 'Request Imprest', color: 'text-teal-600 bg-teal-50' },
    { href: '/company/reports/generate', icon: <Download size={16} />, label: 'Generate Report', color: 'text-slate-600 bg-slate-50' },
  ];
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-2 shrink-0">
          ...
          <Link href="/company/performance" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
...
function ReportsShortcut() {
  const reports = [
    { label: 'Attendance Report', icon: <ScanFace size={16} />, color: 'text-violet-600 bg-violet-50', href: '/company/reports/attendance' },
    { label: 'Leave Report', icon: <CalendarX2 size={16} />, color: 'text-emerald-600 bg-emerald-50', href: '/company/reports/leave' },
    { label: 'Payroll Report', icon: <Wallet size={16} />, color: 'text-amber-600 bg-amber-50', href: '/company/reports/payroll' },
    { label: 'Recruitment Report', icon: <UserRoundPlus size={16} />, color: 'text-blue-600 bg-blue-50', href: '/company/reports/recruitment' },
    { label: 'Performance Report', icon: <BarChart3 size={16} />, color: 'text-purple-600 bg-purple-50', href: '/company/reports/performance' },
    { label: 'Attrition Report', icon: <TrendingDown size={16} />, color: 'text-rose-600 bg-rose-50', href: '/company/reports/attrition' },
    { label: 'Compliance Report', icon: <BadgeCheck size={16} />, color: 'text-teal-600 bg-teal-50', href: '/company/reports/compliance' },
    { label: 'Training Report', icon: <Star size={16} />, color: 'text-orange-600 bg-orange-50', href: '/company/reports/training' },
    { label: 'Expense Report', icon: <Wallet2 size={16} />, color: 'text-indigo-600 bg-indigo-50', href: '/company/reports/expense' },
    { label: 'View All Reports', icon: <FileText size={16} />, color: 'text-slate-600 bg-slate-50', href: '/company/reports' },
    { label: 'Audit Report', icon: <ScanLine size={16} />, color: 'text-pink-600 bg-pink-50', href: '/company/reports/audit' },
  ];
    ...
    <Card className="border-zinc-200/80 shadow-sm">
      <CardContent className="px-2 pt-1.5 pb-1">
        <div className="flex items-center justify-between mb-1">
          ...
          <Link href="/company/reports" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
...
const leaveApprovalsData = [
  { label: 'Leave Requests', count: 12, sub: 'Pending', icon: <CalendarX2 size={16} />, color: 'text-blue-600', bg: 'bg-blue-50', href: '/company/leaves?filter=pending' },
  { label: 'Regularization', count: 3, sub: 'Pending', icon: <ClipboardCheck size={16} />, color: 'text-amber-600', bg: 'bg-amber-50', href: '/company/attendance/regularization' },
  { label: 'Comp Off', count: 5, sub: '', icon: <CalendarCheck size={16} />, color: 'text-emerald-600', bg: 'bg-emerald-50', href: '/company/leaves/comp-off' },
  { label: 'Half Day', count: 2, sub: 'Pending', icon: <Clock3 size={16} />, color: 'text-violet-600', bg: 'bg-violet-50', href: '/company/leaves/half-day' },
];
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[220px] flex flex-col">
      <CardContent className="p-2 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-2 shrink-0">
          ...
          <Link href="/company/leaves" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[220px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-2.5 shrink-0">
          ...
          <Link href="/company/insights" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[220px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-2.5 shrink-0">
          ...
          <Link href="/company/attendance?sort=late" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-3 shrink-0">
          ...
          <Link href="/company/hiring" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-zinc-100">
          <Link href="/company/payroll" className="text-[12px] font-semibold text-violet-600 hover:text-violet-700">Salary Day</Link>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        ...
        <div className="pt-2 border-t border-zinc-100">
          <Link href="/company/compliance" className="text-[12px] font-semibold text-violet-600 hover:text-violet-700 transition-colors">
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-start justify-between mb-2.5 shrink-0">
          ...
          <Link href="/company/celebrations" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-600 hover:text-violet-700 whitespace-nowrap shrink-0 mt-0.5">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        ...
        <div className="flex items-center justify-between mb-2.5 shrink-0">
          ...
          <Link href="/company/audit-logs" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm xl:h-[270px] flex flex-col">
      <CardContent className="p-3 flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between mb-3 shrink-0">
          ...
          <Link href="/company/employees?filter=new" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-700 hover:text-violet-800 whitespace-nowrap">
            View All <ArrowRight size={13} />
          </Link>
        </div>
    ...
    <Card className="border-zinc-200/80 shadow-sm h-full flex flex-col">
      <CardContent className="p-4 flex-1 flex flex-col min-h-0">
        <div className="mb-2.5 flex items-center justify-between shrink-0">
          ...
          <Link href="/company/meetings" className="inline-flex items-center gap-1 text-[11px] font-semibold text-violet-600 hover:text-violet-700">
...
export default function DashboardPage() {
  const { data: config, isLoading } = useQuery<DashboardConfig>({
    ...
    queryFn: async () => (await api.get('/company/config')).data,
  });

  const { data: attendance } = useQuery({
    queryKey: ['dashboard', 'widget', 'team-attendance-today'],
    queryFn: async () => (await api.get('/company/widget-data/team-attendance-today')).data,
  });
