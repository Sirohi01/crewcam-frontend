...
import women from '../../../../../public/super admin images/company successfully created/women.png';
import house from '../../../../../public/super admin images/company successfully created/house.png';
import award from '../../../../../public/super admin images/company successfully created/award.png';
import circle from '../../../../../public/super admin images/company successfully created/circle.png';
...
export default function CompanyCreatedUI() {
  return (
    <div className="w-full max-w-[1600px] px-2 py-1 mx-auto space-y-2 font-sans text-zinc-900 min-h-screen">
      ...
      <div className="grid grid-cols-3 xl:grid-cols-4 gap-2 mt-1">

        {/* Top Left Card (Dark Blue) */}
        <div className="xl:col-span-3 bg-[#020b22] text-white rounded-lg p-3 relative overflow-hidden flex flex-col justify-between shadow-sm">
          ...
          <div className="flex items-start gap-2 relative z-10">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-[9px] text-zinc-300 font-medium mt-0.5">Company ID: <span className="text-white font-semibold">TECHVISION_001</span></p>
            </div>
          </div>
        ...
        <div className="xl:col-span-3 bg-white rounded-lg p-3 border border-zinc-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-2 items-stretch">
          ...
          <div className="flex flex-col gap-3 flex-1">
            <div className="flex items-center gap-2 pb-2 border-b border-zinc-100">
              <div className="h-9 w-9 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0">
                <Image src={house} alt="companyIcon" width={50} height={50} className='rounded-full' />
              </div>
              <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-2 h-full">
          ...
          <div className="bg-[#020b22] text-white rounded-lg p-3 shadow-sm flex items-start gap-2 shrink-0 relative overflow-hidden">
            ...
            <div className="h-9 w-9 rounded-full text-yellow-500 flex items-center justify-center shrink-0  relative z-10">
              <Image src={award} alt="awardIcon" width={50} height={50} className='rounded-full' />
            </div>
