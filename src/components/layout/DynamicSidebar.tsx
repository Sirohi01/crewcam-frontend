...
const STATIC_RECRUITMENT_ITEMS: SidebarItem[] = [
  ...
  { _id: 'r4a', section: 'WORKSPACE', label: 'Submit Application', href: '/dashboard/hiring/candidates/new/create/submit-application', icon: 'UserPlus', order: 2.07, parent: 'Requirement', subParent: 'Job Application' },
